...
public class ParseLoginFragment extends ParseLoginFragmentBase {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent,
        ...
        parseLoginHelpButton.setTypeface(Fonts.setPNALight(getActivity()));
        passwordField.setTypeface(Fonts.setPNALight(getActivity()));
        usernameField.setTypeface(Fonts.setPNALight(getActivity()));

        twitterLoginButton.setTypeface(Fonts.setPNASemiBold(getActivity()));
        facebookLoginButton.setTypeface(Fonts.setPNASemiBold(getActivity()));
        parseLoginButton.setTypeface(Fonts.setPNASemiBold(getActivity()));
        parseSignupButton.setTypeface(Fonts.setPNASemiBold(getActivity()));
