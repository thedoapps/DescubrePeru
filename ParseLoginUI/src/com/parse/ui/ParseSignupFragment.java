...
public class ParseSignupFragment extends ParseLoginFragmentBase implements OnClickListener {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup parent,
    ...
    createAccountButton.setOnClickListener(this);
      ...
      emailField.setTypeface(Fonts.setPNALight(getActivity()));
      confirmPasswordField.setTypeface(Fonts.setPNALight(getActivity()));
      passwordField.setTypeface(Fonts.setPNALight(getActivity()));
      nameField.setTypeface(Fonts.setPNALight(getActivity()));
      createAccountButton.setTypeface(Fonts.setPNASemiBold(getActivity()));
